...
export class Convert {
    public static toProducto(json: string): Producto {
        return cast(JSON.parse(json), r("Producto"));
    }

    public static productoToJson(value: Producto): string {
        return JSON.stringify(uncast(value, r("Producto")), null, 2);
    }
}
...
const typeMap: any = {
    "Producto": o([
        { json: "id_producto", js: "id_producto", typ: 0 },
        { json: "marca", js: "marca", typ: "" },
        { json: "nombre", js: "nombre", typ: "" },
        { json: "imagen", js: "imagen", typ: "" },
        { json: "precio_normal", js: "precio_normal", typ: 0 },
        { json: "precio_oferta", js: "precio_oferta", typ: 0 },
    ], false),
};
